...
const HomePage = () => {
  return (
    <div className="w-full overflow-x-hidden">
      {/* Text Section */}
      <div className="flex flex-col px-4 justify-center text-center items-center mt-[5%] gap-y-5 mb-[5%]">
        ...
        <p className="font-mentiText text-gray-900 text-sm lg:text-xl w-[90%] lg:w-[60%] text-center text-wrap">
      ...
      <div className="w-full relative flex justify-center items-center mt-[10%] lg:mt-[5%]">
        ...
        <video
          className="absolute outline outline-8 outline-purple-200 rounded-lg w-[90%] lg:max-w-3xl h-auto object-fit"
          loop
          autoPlay
          muted
          src={video1}
      ...
      {/* Spacer Section */}
      <div className="w-full flex flex-col justify-center items-center text-center gap-y-4 mt-[9%] mb-[5%] px-4">
        <h2 className="text-xl md:text-5xl font-mentiDisplay">Get started in 3 steps</h2>
        <p className="font-mentiText w-[90%] text-gray-700 text-sm md:text-xl text-wrap">
          AptitudeHub helps you create, interact, and analyze - let's see how!
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-items-center mt-6">
          ...
          <div className="flex flex-col border-[1px] w-72 gap-y-4 border-gray-200 p-4 rounded-md">
            ...
            <img src={Home1} alt="" className="w-full rounded-md" />
            <p>
          ...
          <div className="flex flex-col border-[1px] w-72 gap-y-4 border-gray-200 p-4 rounded-md">
            ...
            <img src={Home2} alt="" className="w-full rounded-md" />
          ...
          <div className="flex flex-col border-[1px] w-72 gap-y-4 border-gray-200 p-4 rounded-md">
            ...
            <img src={Home3} alt="" className="w-full rounded-md" />
            <p>
              Track how your audience reacted to your presentation, with slide-by-slide details after you present. You now have access to valuable insights about the questions you asked.
            </p>
          </div>
        </div>
      </div>
